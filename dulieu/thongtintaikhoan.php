...
<div class="row" style="margin-top: 10px; margin-left: 10px; margin-right: 10px; margin-bottom: 10px;">
	...
	<div class="col-md-9">
		<div class="panel panel-primary">
			<div class="panel-heading"style="padding-left:7em; padding-bottom:2em;"><h3>THÔNG TIN TÀI KHOẢN CỦA BẠN</h3></div>
...
<div class="row" style="padding-left:10em;">
  <?php
            $result5=$conn->query("SELECT DISTINCT idnguoidung,userid,hoten,diachi,email,points,@tsd:=sum(points) from nguoidung n, ketqua k WHERE n.idnguoidung=k.userid and idnguoidung={$idnguoidung}");
            while($row5 = $result5->fetch_assoc())
            {
  ?>
  	<p>Tổng số điểm đạt được là: <?php echo $row5['@tsd:=sum(points)']; ?></p>
    <p><?php echo $row5['points']; ?></p>
  <?php
  }
  ?>
</div>
