<?php
    ...
    $idmenu = $_GET['idmenu'];
    $result = $conn->query("SELECT * from menu WHERE idmenu={$idmenu}");
?>
    ...
    <div class="row">
            ...
            <div class="col-md-9" style="padding-top: 15px;">
                ...
                <div class="panel panel-info">
                    <center><h3>THÔNG TIN CHI TIẾT CHỨC NĂNG WEB</h3></center>
                    <div class="panel-body" style="padding-top:2em;">
                        ...
                        <div>
                            <dl class="dl-horizontal">
                                ...
                                <tr style="padding-bottom:5px">
                                  <b>Tên chức năng: </b><?php echo $row['tenmenu'] ?></br>
                                </tr>
                                <tr style="padding-bottom:5px">
                                  <b>Thứ tự: </b><?php echo $row['stt'] ?></br>
                                </tr>
                                <tr style="padding-bottom:5px">
                                  <b>Ảnh: </b><img src="<?php echo $row['anh'] ?>"style="width:100px;height:50px;"></br>
                                </tr>
                                <tr style="padding-bottom:5px">
                        ...
                        <div style="padding-bottom:2em;">
                            <a href="?thread=chucnang"><button type="button" class="btn btn-success">Trở về</button></a>
                        </div>
                        <?php
                            }
                        ?>
