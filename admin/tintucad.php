                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-green">
                            <div class="panel-heading">
                              <center><h3>DANH SÁCH CÁC TIN TỨC </h3></center>
                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align: center">Tiêu đề 1</th>
                                            <th style="text-align: center">Tiêu đề 2</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center">
                                                <?php echo $row['tieude1'] ?>
                                            </td>
                                            <td style="text-align: center">
                                                <?php echo $row['tieude2'] ?>
                                            </td>
                                            <td style="text-align: center">
                                                <?php echo $row['link'] ?>
                                            </td>
