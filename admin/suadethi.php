<?php
    ...
    $result = $conn->query("SELECT * FROM dethi a, monhoc b WHERE a.idmonhoc=b.idmonhoc and iddethi = '{$iddethi}'");
?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                      <div class="panel panel-warning">
												<div class="panel-heading" ><h4>CHỈNH SỬA THÔNG TIN ĐỀ THI</h4></div>
                                    ...
                                    <div class="form-group">
                                      <div class="control-label col-sm-3">
                                        <b style="font-size: 15px;">Môn học:</b>
                                      </div>
                                      <div class="col-sm-9">
                                        <div class="col-sm-9">
                                        <select class="form-control" id="idmh" name="idmh">
                                            <?php
                                                while($row = $result->fetch_assoc())
                                                {
                                            ?>
                                                    <option value="<?php echo $row['idmonhoc']; ?>"><?php echo $row['tenmonhoc']; ?></option>
                                            <?php
                                                }
                                            ?>
                                        </select>
