                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-green">
                            <div class="panel-heading">
                              <center><h3>DANH SÁCH CÁC CÂU HỎI</h3></center></br>
                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center">
                                                <a href="?thread=xemcauhoi&idcauhoi=<?php echo $row['idcauhoi']; ?>"><button type="button" class="btn btn-default"><span class="glyphicon glyphicon-pencil"></span></button></a>

                                                <a href="?thread=suacaihoi&idcauhoi=<?php echo $row['idcauhoi']; ?>"><button type="button" class="btn btn-success"><span class="glyphicon glyphicon-zoom-in"></span></button><a/>
                                                <a href="#"><button type="button" class="btn btn-info"><span class="glyphicon glyphicon-pencil"></span></button></a>
                                                <a href="?thread=xoacauhoi&idcauhoi=<?php echo $row['idcauhoi']; ?>"><button type="button" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></button></a>
