<?php
    ...
    $result = $conn->query("SELECT * from nhabachoc");
?>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-green">
                            <div class="panel-heading">
                              <center><h3>DANH SÁCH CÁC NHÀ KHOA HỌC </h3></center>
                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align: center">Tên nhà khoa học</th>
                                            <th style="text-align: center">Năm sinh</th>
                                            <th style="text-align: center">Chức danh</th>
                                            <th style="text-align: center">Tiểu sử</th>
